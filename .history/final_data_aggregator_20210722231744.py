...
for s in state_names:
    ...
    with pd.ExcelWriter(path+'/Air_Quality/'+s+'_EPA_Emissions_Data.xlsx') as writer:  
    ...
    with pd.ExcelWriter(path+sa+'/Air_Quality/'+s+'_PM25_Racial_Disparities.xlsx') as writer:  
