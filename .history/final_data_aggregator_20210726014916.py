...
for s in state_names:
    ...
    if(restart_states_co2):
        ...
        df_emit = eia_state.return_state_EIA_data(1970, 2020, sa, eia_state.get_emit_tags(sa))
        df_emit.T.to_csv(path+'/CO2 Emissions/'+sa+' EIA CO2 Emissions Data.csv')
    bad = path+'/CO2 Emissions/'+sa+' EIA CO2 missions Data.csv'
    good = path+'/CO2 Emissions/'+sa+' EIA CO2 Emissions Data.csv'
    os.rename(bad, good)
