...
for s in state_names:
    ...
    if(restart_states_infrastructure):
        ...
        folder_refresh(path+'/Buildings Infrastructure/State Totals')
        folder_refresh(path+'/Buildings Infrastructure/County Totals')
        ...
        temp_path = path+'/Buildings Infrastructure/State Totals/'+us_state_abbrev[sa]
        df_infrastructure.to_csv(temp_path+' Full.csv')
        ...
        temp_path = path+'/Buildings Infrastructure/'+us_state_abbrev[sa]
        df_infrastructure.to_csv(temp_path+' All Buildings Data.csv')
        df_rentown.to_csv(temp_path+' Building Tenure Data.csv')
        df_yrblt.to_csv(temp_path+' Building Vintage Data.csv')
        df_units.to_csv(temp_path+' Building Type Data.csv')
        df_hf.to_csv(temp_path+' Building Heating Fuel Data.csv')
        df_rooms.to_csv(temp_path+' Building Rooms Data.csv')
