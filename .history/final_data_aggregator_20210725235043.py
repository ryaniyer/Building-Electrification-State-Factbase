...
restart_states_infrastructure = True
...
for s in state_names:
    ...
    if(restart_states_infrastructure):
        ...
        temp_path = path+'/Buildings Infrastructure/State-Level/'+us_state_abbrev[sa]
        ...
        ttemp_path = path+'/Buildings Infrastructure/County-Level/' + sa + ' By County'
        df_infrastructure.to_csv(temp_path+' Full.csv')
        df_rentown.to_csv(temp_path+' Building Tenure.csv')
        df_yrblt.to_csv(temp_path+' Building Vintage.csv')
        df_units.to_csv(temp_path+' Building Type.csv')
