...
os.mkdir('./State Factbook/National Data/Natural_Gas')
#AGA Export:
aga_path = 'Static/Natural_Gas/1972-2019 AGA Construction Expenses.xlsx'
shutil.copy(aga_path, './State Factbook/National Data/Natural_Gas/AGA Construction Expenses.xlsx')
df = pd.read_excel('Static/Natural_Gas/1972-2019 AGA Construction Expenses.xlsx')
...
for s in state_names:
    ...
    with pd.ExcelWriter(path+'/Air Quality/'+s+'_EPA_Emissions_Data.xlsx') as writer:  
    ...
    with pd.ExcelWriter(path+'/Air Quality/'+s+'_PM25_Racial_Disparities.xlsx') as writer:  
