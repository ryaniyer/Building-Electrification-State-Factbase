...
for s in state_names:
    ...
    if(restart_states_infrastructure):
        shutil.rmtree(path+'/Buildings Infrastructure')
        ...
        df_rentown.to_csv(path+'/Buildings Infrastructure/'+sa+' Building Data.csv')
        df_yrblt.to_csv(path+'/Buildings Infrastructure/'+sa+' Building Age Data.csv')
