...
def get_energy_price_data(sa):
    ...
    dfr.loc['Natural Gas Residential Price $/Tcf ' + ia_note] = [inf_adj[i] * ngresprice[i] for i in range(len(inf_adj))]
    dfr.loc['Natural Gas Commercial Price $/Tcf ' + ia_note] = [inf_adj[i] * ngcomprice[i] for i in range(len(inf_adj))]
    dfr.loc['Electricity Residential Price $/MMBtu ' + ia_note] = [inf_adj[i] * elecresprice[i] for i in range(len(inf_adj))]
    dfr.loc['Electricity Commercial Price $/MMBtu ' + ia_note] = [inf_adj[i] * eleccomprice[i] for i in range(len(inf_adj))]
